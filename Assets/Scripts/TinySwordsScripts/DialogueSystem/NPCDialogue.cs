...
public class NPCDialogue : ScriptableObject
{
    ...
    public int questCompletedIndex; // What does he saya when quest completed
    public Quest quest; // Quest NPC gives

    [Header("Battle System")]
    public bool canBattle = false;
    public NPCBattleConfig battleConfig;
    public int battleWonDialogueIndex; 
    public int battleLostDialogueIndex; 
}
